...
class Categoria extends BaseController
{
    ...
    protected $filters = [
        'nome_categoria' => 'trim|sanitize_string|upper_case'
    ];
    ...
    public function ajax_lista($data)
    {
        ...
        if (!empty($lista_categorias)) :
            foreach ($lista_categorias as $categoria) {
                $corpoTabela .= "<tr>";
                $corpoTabela .= "<td>" . htmlentities(utf8_encode($categoria['id'])) . "</td>";
                $corpoTabela .= "<td>" . htmlentities($categoria['nome_categoria'], ENT_QUOTES, 'UTF-8') . "</td>";
    ...
    // ***********************************************************************
    // chama a view para entrada dos dados da categoria
    ...
    public function gravarAlterar()
    {
        ...
        if ($_SERVER['REQUEST_METHOD'] == 'POST') :
            ...
            if ($_POST['CSRF_token'] == $_SESSION['CSRF_token']) :
                ...
                $rules = [
                    'nome_categoria_alteracao'    => 'required|min_len,2|max_len,40',
                ];
                ...
                if ($post_validado === true) :  // verificar dados da categoria
                    ...
                    $categoriaModel = $this->model("CategoriaModel");
                    $categoria = $categoriaModel->get($_POST['id_alteracao']);
